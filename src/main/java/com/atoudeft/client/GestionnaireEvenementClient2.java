...
//                    break;
                ...
                case "NOUVEAU":
                    ...
                    if (arg.trim().startsWith("NO")) {
                        ...
                        // Question 1.1 Pour envoyer le statut que le client est connect
                ...
                case "EPARGNE" :
                    ...
                    panneauPrincipal.ajouterCompte(t[1] + "[Epargne]");
                    break;
                case "SELECT" :
                    arg = evenement.getArgument();
                ...
                case "DEPOT" :
                    ...
                    t = arg.split(" ");
                    if(t[0].equalsIgnoreCase("OK"))
                    {
                        //panneauPrincipal..setSolde(t[1]);
                    }
                    break;
                case "RETRAIT" :
                    arg = evenement.getArgument();
